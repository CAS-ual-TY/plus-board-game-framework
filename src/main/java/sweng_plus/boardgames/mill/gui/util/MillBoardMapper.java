...
public class MillBoardMapper
{
    ...
    public static Vector2i getCoordsForIndex(int index)
    {
        switch(index)
        {
            case 0 : return new  Vector2i(-3, -3);
            case 1 : return new Vector2i(0, -3);
            case 2 : return new Vector2i(3, -3);
            case 3 : return new Vector2i(3, 0);
            case 4 : return new Vector2i(3, 3);
            case 5 : return new Vector2i(0, 3);
            case 6 : return new Vector2i(-3, 3);
            case 7 : return new Vector2i(-3, 0);
            case 8 : return new Vector2i(-2, -2);
            case 9 : return new Vector2i(0, -2);
            case 10 : return new Vector2i(2, -2);
            case 11 : return new Vector2i(2, 0);
            case 12 : return new Vector2i(2, 2);
            case 13 : return new Vector2i(0, 2);
            case 14 : return new Vector2i(-2, 2);
            case 15 : return new Vector2i(-2, 0);
            case 16 : return new Vector2i(-1, -1);
            case 17 : return new Vector2i(0, -1);
            case 18 : return new Vector2i(1, -1);
            case 19 : return new Vector2i(1, 0);
            case 20 : return new Vector2i(1, 1);
            case 21 : return new Vector2i(0, 1);
            case 22 : return new Vector2i(-1, 1);
            case 23 : return new Vector2i(-1, 0);
            default :
            {

...
public class NameScreen extends Screen
{
    public NameScreen(IScreenHolder screenHolder)
    {
        ...
        widgets.add(new TextWidget(screenHolder, textDims, Ludo.instance().fontRenderer64, Ludo.instance().names, Color4f.BLACK));
        ...
        widgets.add(new TextWidget(screenHolder, cancelDims, Ludo.instance().fontRenderer32, "Zurück zum Menü", Color4f.BLACK));
    }
